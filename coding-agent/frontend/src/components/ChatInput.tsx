  ...
  return (
    <div className="p-6 bg-gradient-to-t from-white via-white to-transparent">
      <form
        ...
        className={`
          relative flex items-center gap-2 rounded-xl border bg-white p-2 shadow-sm transition-all
          ${disabled ? 'border-slate-100 opacity-70 cursor-not-allowed' : 'border-slate-300 focus-within:border-blue-500 focus-within:ring-4 focus-within:ring-blue-500/10'}
        `}
      >
