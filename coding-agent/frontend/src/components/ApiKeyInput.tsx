  ...
  if (isConfigured && !isEditing) {
    return (
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 text-xs text-emerald-600 bg-emerald-50 border border-emerald-200 rounded-lg hover:bg-emerald-100 transition-colors"
      >
        <Check size={14} />
    ...
    <form onSubmit={handleSubmit} className="flex items-center gap-2">
      <div className="relative">
        ...
        <input
          ...
          placeholder="sk-ant-..."
          className="w-48 pl-8 pr-8 py-1.5 text-xs bg-white border border-slate-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10"
        />
        <button
          type="button"
